...
{
    [TestFixture]
    public class BondInterestCalculatorActual_365F_Test
    {
        [Test]
        ...
        private BondInterestCalculatorActual_365F CreateBondInterestCalculator()
        {
            return new BondInterestCalculatorActual_365F();
        }
    }
}
