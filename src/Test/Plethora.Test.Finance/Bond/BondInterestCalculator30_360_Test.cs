...
{
    [TestFixture]
    public class BondInterestCalculator30_360_Test
    {
        [Test]
        ...
        private BondInterestCalculator30_360 CreateBondInterestCalculator()
        {
            return new BondInterestCalculator30_360();
        }
    }
}
