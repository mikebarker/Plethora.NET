...
namespace Plethora.Windows.Forms
{
	...
	/// <remarks>
	///	 <para>
	///	  When binding to the <see cref="Value"/> property of a <see cref="DecimalTextBox"/>
    ...
    public class DecimalTextBox : RestrictedTextBox, IValueTextBox
    {
        #region Fields
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="DecimalTextBox"/> class.
        /// </summary>
        public DecimalTextBox()
        {
            this.TextAlign = HorizontalAlignment.Right;
            this.FormatParser = NumericFormatParser<Decimal>.Default;
        ...
        private void DecimalTextBox_MaxValueChanged(object sender, EventArgs e)
        {
            if (this.EditMode == EditMode.Display)
            {
        ...
        private void DecimalTextBox_MinValueChanged(object sender, EventArgs e)
        {
            if (this.EditMode == EditMode.Display)
            {
        ...
        /// <summary>
        /// Validate the Decimal value for this <see cref="DecimalTextBox"/>, allowing
		...
		/// <see cref="DecimalTextBox"/>. A return value indicates whether the
		/// operation succeeded.
		/// </summary>
		/// <param name="text">A string containing a number to convert.</param>
		/// <param name="result">
        ...
        {
            this.MaxValueChanged += DecimalTextBox_MaxValueChanged;
            this.MinValueChanged += DecimalTextBox_MinValueChanged;
