...
namespace Plethora.Windows.Forms
{
	...
	/// <remarks>
	///	 <para>
	///	  When binding to the <see cref="Value"/> property of a <see cref="RealTextBox"/>
    ...
    public class RealTextBox : RestrictedTextBox, IValueTextBox
    {
        #region Fields
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="RealTextBox"/> class.
        /// </summary>
        public RealTextBox()
        {
            this.TextAlign = HorizontalAlignment.Right;
            this.FormatParser = NumericFormatParser<Double>.Default;
        ...
        private void RealTextBox_MaxValueChanged(object sender, EventArgs e)
        {
            if (this.EditMode == EditMode.Display)
            {
        ...
        private void RealTextBox_MinValueChanged(object sender, EventArgs e)
        {
            if (this.EditMode == EditMode.Display)
            {
        ...
        /// <summary>
        /// Validate the Double value for this <see cref="RealTextBox"/>, allowing
		...
		/// <see cref="RealTextBox"/>. A return value indicates whether the
		/// operation succeeded.
		/// </summary>
		/// <param name="text">A string containing a number to convert.</param>
		/// <param name="result">
        ...
        {
            this.MaxValueChanged += RealTextBox_MaxValueChanged;
            this.MinValueChanged += RealTextBox_MinValueChanged;

			this.TextChanged += RealTextBox_TextChanged;
        }
