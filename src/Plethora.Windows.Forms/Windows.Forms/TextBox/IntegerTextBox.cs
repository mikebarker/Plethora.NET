...
namespace Plethora.Windows.Forms
{
    ...
    /// <remarks>
    ///	 <para>
    ///	  When binding to the <see cref="Value"/> property of a <see cref="IntegerTextBox"/>
    ///	  the 'formattingEnabled' must be specified as true.
    ///	  <example>
    ///	   <code>IntegerTextBox.DataBindings.Add("Value", myClass, "InnerValue", true);</code>
    ///	  </example>
    ///	 </para>
    /// </remarks>
    ...
    public class IntegerTextBox : RestrictedTextBox, IValueTextBox
    {
        #region Fields
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="IntegerTextBox"/> class.
        /// </summary>
        public IntegerTextBox()
        {
            this.TextAlign = HorizontalAlignment.Right;
            this.FormatParser = NumericFormatParser<Int64>.Default;
        ...
        private void IntegerTextBox_MaxValueChanged(object sender, EventArgs e)
        {
            if (this.EditMode == EditMode.Display)
            {
        ...
        private void IntegerTextBox_MinValueChanged(object sender, EventArgs e)
        {
            if (this.EditMode == EditMode.Display)
            {
        ...
        /// <summary>
        /// Validate the Int64 value for this <see cref="IntegerTextBox"/>, allowing
        ...
        /// <see cref="IntegerTextBox"/>. A return value indicates whether the
        /// operation succeeded.
        /// </summary>
        /// <param name="text">A string containing a number to convert.</param>
        /// <param name="result">
        ...
        {
            this.MaxValueChanged += IntegerTextBox_MaxValueChanged;
            this.MinValueChanged += IntegerTextBox_MinValueChanged;
