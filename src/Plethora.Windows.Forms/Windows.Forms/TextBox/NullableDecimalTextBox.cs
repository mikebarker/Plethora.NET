...
namespace Plethora.Windows.Forms
{
	...
	/// <remarks>
	///	 <para>
	///	  When binding to the <see cref="Value"/> property of a <see cref="NullableDecimalTextBox"/>
	///	  the 'formattingEnabled' must be specified as true.
	///	  <example>
	///	   <code>nullableRealTextBox.DataBindings.Add("Value", myClass, "InnerValue", true);</code>
	///	  </example>
	///	 </para>
	/// </remarks>
    ...
    public class NullableDecimalTextBox : RestrictedTextBox, IValueTextBox
    {
        #region Fields
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="NullableDecimalTextBox"/> class.
        /// </summary>
        public NullableDecimalTextBox()
        {
            this.TextAlign = HorizontalAlignment.Right;
            this.FormatParser = NullableNumericFormatParser<Decimal>.Default;
        ...
        /// <summary>
        /// Validate the input to test for a valid Decimal? value for this
        /// <see cref="NullableDecimalTextBox"/>.
        /// </summary>
        /// <param name="text">
        ...
        private IFormatParserPartial<Decimal?> formatParser = null;
        ...
        public IFormatParserPartial<Decimal?> FormatParser
        {
        ...
        private Decimal? value = DEFAULT_VALUE;
        ...
        private void NullableDecimalTextBox_MaxValueChanged(object sender, EventArgs e)
        {
            if (this.EditMode == EditMode.Display)
            {
        ...
        private void NullableDecimalTextBox_MinValueChanged(object sender, EventArgs e)
        {
            if (this.EditMode == EditMode.Display)
            {
		...
		private void NullableDecimalTextBox_TextChanged(object sender, EventArgs e)
		{
        ...
        /// <summary>
        /// Validate the Decimal? value for this <see cref="NullableDecimalTextBox"/>, allowing
        /// for the user to type in the value.
        /// </summary>
		/// <param name="validateValue">
        /// The Decimal? value to be validated.
        /// </param>
        /// <param name="partial">
        ...
        /// </param>
        /// <returns>
        /// 'true' if the value represents a valid Decimal? value; else 'false'.
        /// </returns>
        /// <example>
        ...
        /// 'true' if the value represents a valid Decimal? value; else 'false'.
        /// </returns>
		protected bool ValidateValue(Decimal? validateValue)
        {
        ...
        /// <param name="result">
        /// When this method returns, contains the Decimal? value equivalent to the
		...
		/// <see cref="NullableDecimalTextBox"/>. A return value indicates whether the
		/// operation succeeded.
		/// </summary>
		/// <param name="text">A string containing a number to convert.</param>
		/// <param name="result">
		...
		/// 'false'.
		/// </returns>
		protected bool TryParseAndValidate(string text, out Decimal? result)
		{
        ...
        {
            this.MaxValueChanged += NullableDecimalTextBox_MaxValueChanged;
            this.MinValueChanged += NullableDecimalTextBox_MinValueChanged;

			this.TextChanged += NullableDecimalTextBox_TextChanged;
        }
