...
namespace Plethora.Windows.Forms
{
	...
	/// <remarks>
	///	 <para>
	///	  When binding to the <see cref="Value"/> property of a <see cref="NullableRealTextBox"/>
    ...
    public class NullableRealTextBox : RestrictedTextBox, IValueTextBox
    {
        #region Fields
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="NullableRealTextBox"/> class.
        /// </summary>
        public NullableRealTextBox()
        {
            this.TextAlign = HorizontalAlignment.Right;
            this.FormatParser = NullableNumericFormatParser<Double>.Default;
        ...
        /// <summary>
        /// Validate the input to test for a valid Double? value for this
        /// <see cref="NullableRealTextBox"/>.
        /// </summary>
        /// <param name="text">
        ...
        private IFormatParserPartial<Double?> formatParser = null;
        ...
        public IFormatParserPartial<Double?> FormatParser
        {
        ...
        private void NullableRealTextBox_MaxValueChanged(object sender, EventArgs e)
        {
            if (this.EditMode == EditMode.Display)
            {
        ...
        private void NullableRealTextBox_MinValueChanged(object sender, EventArgs e)
        {
            if (this.EditMode == EditMode.Display)
            {
		...
		private void NullableRealTextBox_TextChanged(object sender, EventArgs e)
		{
        ...
        /// <summary>
        /// Validate the Double? value for this <see cref="NullableRealTextBox"/>, allowing
        /// for the user to type in the value.
        /// </summary>
		/// <param name="validateValue">
        /// The Double? value to be validated.
        /// </param>
        /// <param name="partial">
        ...
        /// </param>
        /// <returns>
        /// 'true' if the value represents a valid Double? value; else 'false'.
        /// </returns>
        /// <example>
        ...
        /// </example>
		protected virtual bool ValidateValue(Double? validateValue, bool partial)
        {
        ...
        /// 'true' if the value represents a valid Double? value; else 'false'.
        /// </returns>
		protected bool ValidateValue(Double? validateValue)
        {
        ...
        /// </returns>
        protected virtual bool TryParse(string text, out Double? result)
        {
		...
		/// <see cref="NullableRealTextBox"/>. A return value indicates whether the
		/// operation succeeded.
		/// </summary>
		/// <param name="text">A string containing a number to convert.</param>
		/// <param name="result">
		...
		/// 'false'.
		/// </returns>
		protected bool TryParseAndValidate(string text, out Double? result)
		{
        ...
        {
            this.MaxValueChanged += NullableRealTextBox_MaxValueChanged;
            this.MinValueChanged += NullableRealTextBox_MinValueChanged;

			this.TextChanged += NullableRealTextBox_TextChanged;
        }
