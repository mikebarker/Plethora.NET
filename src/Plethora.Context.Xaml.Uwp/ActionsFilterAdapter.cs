...
namespace Plethora.Context
{
    ...
    public class ActionsFilterAdapter : DependencyObject, IActionsAdapter
    {
        ...
        {
            this.SetValue(IncludePatternsProperty, new ObservableCollection<string>());
            this.SetValue(ExcludePatternsProperty, new ObservableCollection<string>());
        }

        #region IncludePatterns Dependency Property

        private static readonly DependencyProperty IncludePatternsProperty = DependencyProperty.Register(
        ...
        private static readonly DependencyProperty ExcludePatternsProperty = DependencyProperty.Register(
