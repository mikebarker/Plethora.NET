...
namespace Plethora.Context
{
    ...
    public class ActionsPrecedenceAdapter : DependencyObject, IActionsAdapter
    {
        ...
        {
            this.SetValue(PrecedenceListsProperty, new ObservableCollection<IList<string>>());
        }

        #region PrecedenceLists Dependency Property

        private static readonly DependencyProperty PrecedenceListsProperty = DependencyProperty.Register(
